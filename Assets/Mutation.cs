...
namespace Skeleton {
	...
	public class Mutation {
		...
		public List<GameObject> crossBreeds;
		 ...
		 * */
		public Mutation(GameObject go, float mutationChance = 0.9f, float scaleMutationAmplitude = 0.8f,  float lengthMutationAmplitude = 0.8f, float rotationMutationAmplitude = 50f) {
			this.gameObject = go;//Object.Instantiate(go);
			...
			this.crossBreeds = new List<GameObject> ();
		}

		public Mutation(List<GameObject> gos, float mutationChance = 0.15f, float scaleMutationAmplitude = 0.3f,  float lengthMutationAmplitude = 0.3f, float rotationMutationAmplitude = 50f): 
		this(gos [0], mutationChance, scaleMutationAmplitude, lengthMutationAmplitude, rotationMutationAmplitude) {
			this.crossBreeds.AddRange (gos.GetRange(1, gos.Count - 1));
		}

		public GameObject getMutatedObject() {
			GameObject mutant = Object.Instantiate (this.gameObject);
			this.dfsMutation (mutant, 0);
